...
config :rocketpay, RocketpayWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "GHuBdp5yj70xJAzsVMfeh5KjjjppjuEHEGW7OKeTgs5lYgnvoqp4PSfgSANhdPYz",
  render_errors: [view: RocketpayWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Rocketpay.PubSub,
  live_view: [signing_salt: "+kQUZYqO"]

# nova configuração mudar PK de inteiro pra binario
